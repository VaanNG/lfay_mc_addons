...
execute as @initiator[scores={Moneyz=..29}] run tell @s §cYou can't buy 10 Raw Beefs!
...
execute as @initiator[scores={Moneyz=30..}] run tell @s §aYou can buy 10 Raw Beefs!

execute as @initiator[scores={Moneyz=30..}] run give @s beef 10

execute as @initiator[scores={Moneyz=30..}] run tell @s §aPurchased 10 Raw Beefs!
