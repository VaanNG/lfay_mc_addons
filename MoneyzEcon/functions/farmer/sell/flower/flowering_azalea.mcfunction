...
tell @initiator[hasitem={item=flowering_azalea,quantity=..0}] §cYou can't sell 1 Flowering Azalea!

playsound random.levelup @initiator[hasitem={item=flowering_azalea,quantity=1..}] ~ ~ ~

tell @initiator[hasitem={item=flowering_azalea,quantity=1..}] §aYou can sell 1 Flowering Azalea!

scoreboard players add @initiator[hasitem={item=flowering_azalea,quantity=1..}] Moneyz 5

tell @initiator[hasitem={item=flowering_azalea,quantity=1..}] §aSold 1 Flowering Azalea!
